...
def load_user_with_relationships(
    ...
    This function eagerly loads User.roles to prevent detached instance errors
    when the session is closed or rolled back.

    IMPORTANT: Always use this function instead of security_manager.find_user()
    when loading users for MCP tool execution.
